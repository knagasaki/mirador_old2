  ...
  $.ThumbnailsView.prototype = {
    ...
    init: function() {
      ...
      if(this.vDirectionStatus == 'rtl'){
         ...
         var fCanvasThumSelector = 'img.thumbnail-image[data-image-id="'+fCanvas
Id+'"]';
         jQuery(fCanvasThumSelector).parents('.panel-thumbnail-view').addClass('
v-direction-rtl');
         jQuery(fCanvasThumSelector).parents('.thumbnail-view').find('li').each(
function(){
